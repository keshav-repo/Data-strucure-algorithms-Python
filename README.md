...
|    | Program Name                                                                        | Input                                     | Expected Output                    | Question Reference                                                                              | Solution Reference           |
|----|-------------------------------------------------------------------------------------|-------------------------------------------|------------------------------------|-------------------------------------------------------------------------------------------------|------------------------------|
...
| 9  | Move all negative numbers to beginning and positive to end with using another list. | Input: -12, 11, -13, -5, 6, -7, 5, -3, -6 | Output: -12 -13 -5 -7 -3 -6 11 6 5 |                                                                                                 | MoveElements.py              |
| 10 | Program to cyclically rotate an list by one                                         | Input:[1, 2, 3, 4, 5]                     | Output: [5, 1, 2, 3, 4]            |                                                                                                 | SiftElementList.py           |
| 11 | Find the first repeating element in an List of integers                             | Input: 6, 10, 5, 4, 9, 120, 4, 6, 10      | Output: 6         |                                                                                                 | FirstRepeatingElelment.py    |
| 12 | Concatenation of Array  |                     |                                    | [leetcode](https://leetcode.com/problems/concatenation-of-array/)                               |  ConcatinateList.py                            |
| 13 | Shuffle the Array      |                  |               | [leetcode](https://leetcode.com/problems/shuffle-the-array/)                                    | SuffleArray.py               |
| 14 | Left and Right Sum Differences  |                  |               | [leetscode](https://leetcode.com/problems/left-and-right-sum-differences/)                      | LeftAndRightSumDiff.py       |
| 15 | How Many Numbers Are Smaller Than the Current Number|                  |               | [leetcode](https://leetcode.com/problems/how-many-numbers-are-smaller-than-the-current-number/) | SmallestNumThanCurr.py       |
...
| 10 | Check if the Sentence Is Pangram |                        | [leetcode](https://leetcode.com/problems/check-if-the-sentence-is-pangram/)                 | PangramString.py  |
| 11 | Count Number of Pairs With Absolute Difference K  |                        | [leetcode](https://leetcode.com/problems/count-number-of-pairs-with-absolute-difference-k/) |   AbsoluteDifferenceK.py |
| 12 | Count the Number of Consistent Strings     |                        | [leetcode](https://leetcode.com/problems/count-the-number-of-consistent-strings/)           |                   |
| 13 | Rings and Rods   |                        | [leetcode](https://leetcode.com/problems/rings-and-rods/)                                   | RingRoads.py      |
| 14 | Destination City |                        | [leetcode](https://leetcode.com/problems/destination-city/)                                 |                   |
